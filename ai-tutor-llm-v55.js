...
const OllamaAPI = {
  _url: 'https://cal-app-anime-early.trycloudflare.com/api/chat',
  _model: 'qwen3.5:9b',
  ...
  async detect() {
    try {
      const r = await fetch('https://cal-app-anime-early.trycloudflare.com/api/tags', { method: 'GET', signal: AbortSignal.timeout(2000) });
      if (r.ok) {
